...
- [ ] 05-02-PLAN.md — add `.pill-codex` + `.pill-gemini` CSS classes to dashboard/app/globals.css (QUEU-02)
- [ ] 05-03-PLAN.md — readSupervisorRuns normalized reader for codex/gemini supervisor audit entries (QUEU-03)
- [ ] 05-04-PLAN.md — supervisor audit emission normalization across the 4 runtimes
- [ ] 05-05-PLAN.md — flock wrap on audit.jsonl write path (QUEU-04) + hooks/sleepwalker-audit-log.sh
- [ ] 05-06-PLAN.md — SAFE-01 char-budget SIGTERM + cli-budget-exceeded event labeling
- [ ] 05-07-PLAN.md — queue-client.tsx UI source branch for codex/gemini pills + source filter
- [ ] 05-08-PLAN.md — Phase 5 exit gate + VALIDATION flip + frozen-surface diff
**UI hint**: yes
